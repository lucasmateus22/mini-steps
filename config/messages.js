...
export const victoryMessage = '🎉 Parabéns! Você completou a fase! Você é incrível!';

export const startMessage = 'Bem-vindo! Use ← → para mover e ESPAÇO para pular. Boa sorte!';
